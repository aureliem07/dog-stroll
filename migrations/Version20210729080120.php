 ...
 */
final class Version20210729080120 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE town (id INT AUTO_INCREMENT NOT NULL, department INT NOT NULL, name VARCHAR(255) NOT NULL, simple_name VARCHAR(255) NOT NULL, real_name VARCHAR(255) NOT NULL, postal_code INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
